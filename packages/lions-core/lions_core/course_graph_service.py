"""
Neo4j 그래프 도메인 서비스 — 교과목 유사도 기반 분석·추천 질의(Cypher).

인프라(연결/세션/health)는 graph_connection 모듈로 분리했다.
"""
...
from lions_core.graph_connection import get_session, is_graph_available
