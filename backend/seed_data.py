...
def seed_database():
    ...
    try:
        ...
        db.add_all([college1, college2, college3, college4, college5, college6, college7, college8])
        db.commit()
        ...
        departments_list = [
            ...
            # 소프트웨어융합대학
            Department(id=301, code="CS", name="컴퓨터학부", college_id=3, min_credits=130),
            Department(id=302, code="ICT", name="ICT융합학부", college_id=3, min_credits=130),
            Department(id=303, code="AI", name="인공지능학과", college_id=3, min_credits=130),
            Department(id=304, code="MATH", name="수리데이터사이언스학과", college_id=3, min_credits=130),

            
            # 첨단융합대학
            Department(id=401, code="PHYS", name="물리학과", college_id=4, min_credits=126),
            Department(id=402, code="CHEM", name="화학과", college_id=4, min_credits=126),
            Department(id=403, code="BIO", name="생명과학과", college_id=4, min_credits=126),
            Department(id=404, code="EARTH", name="지구환경과학과", college_id=4, min_credits=126),
            Department(id=405, code="ASTRO", name="천문우주학과", college_id=4, min_credits=126),
            
            # 경상대학
            Department(id=501, code="BIZ", name="경영학과", college_id=5, min_credits=126),
            Department(id=502, code="ACCT", name="회계학과", college_id=5, min_credits=126),
            Department(id=503, code="FIN", name="재무금융학과", college_id=5, min_credits=126),
            Department(id=504, code="MKT", name="마케팅학과", college_id=5, min_credits=126),

            # 글로벌문화통상대학
            Department(id=601, code="KOR", name="글로벌문화통상학부", college_id=6, min_credits=126),
            
            # 커뮤니케이션%컬쳐대학
            Department(id=701, code="ECON", name="광고홍보학과", college_id=7, min_credits=126),
            Department(id=702, code="POL", name="문화콘텐츠학과", college_id=7, min_credits=126),
            Department(id=703, code="SOC", name="문화인류학과", college_id=7, min_credits=126),
            Department(id=704, code="PSY", name="미디어학과", college_id=7, min_credits=126),
            
            # 디자인대학
            Department(id=801, code="DESIGN", name="융합디자인학부", college_id=8, min_credits=130),
            Department(id=802, code="INDUST_DESIGN", name="산업디자인학과", college_id=8, min_credits=130),
            Department(id=803, code="VISUAL_DESIGN", name="시각디자인학과", college_id=8, min_credits=130),
        ]
        ...
        advisors = [
            ...
            # 공과대학
            Advisor(id=4, name="이교수", email="lee.ee@hanyang.ac.kr", department_id=202),  # 전자공학과
            Advisor(id=5, name="정교수", email="jung.me@hanyang.ac.kr", department_id=203),  # 기계공학과
            Advisor(id=6, name="강교수", email="kang.chem@hanyang.ac.kr", department_id=204),  # 화학공학과
            # 소프트웨어융합대학
            Advisor(id=7, name="송교수", email="song.cs@hanyang.ac.kr", department_id=301),  # 컴퓨터학부
            Advisor(id=8, name="윤교수", email="yoon.math@hanyang.ac.kr", department_id=304),  # 수리데이터사이언스학과
            # 첨단융합대학
            Advisor(id=9, name="한교수", email="han.phys@hanyang.ac.kr", department_id=401),  # 물리학과
            Advisor(id=10, name="오교수", email="oh.chem@hanyang.ac.kr", department_id=402),  # 화학과
            # 경상대학
            Advisor(id=11, name="서교수", email="seo.biz@hanyang.ac.kr", department_id=501),  # 경영학과
            # 글로벌문화통상대학
            Advisor(id=12, name="안교수", email="ahn.global@hanyang.ac.kr", department_id=601),  # 글로벌문화통상학부
        ]
        ...
        last_names = ["김", "이", "박", "최", "정", "강", "조", "윤", "장", "임", "한", "오", "서", "신", "권", "황", "안", "송", "홍", "전"]
        ...
        for idx, course_data in enumerate(sw_data['curriculum'], start=1):
            ...
            is_recommended = course_data['course_type'] in ['전공기초', '전공핵심', '교양필수']
        ...
        first_year_first_sem_courses = [
            idx + 1 for idx, course in enumerate(sw_data['curriculum']) 
        ...
        for dept_id, _, count_r2 in dept_preferences:
            for _ in range(count_r2):
                ...
                survey = MajorSurvey(
                    ...
                    submitted_at=datetime(2026, 1, random.randint(15, 31)) if random.randint(15, 31) <= 31 else datetime(2026, 2, random.randint(1, 15))
                )
                surveys.append(survey)
                student_index2 += 1
