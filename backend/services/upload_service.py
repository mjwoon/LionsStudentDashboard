...
AdminService(God-object)에서 '대량 데이터 업로드' 책임을 분리한 것.
_generic_upload upsert 엔진과 엔티티별 upload_* 메서드를 담는다.
"""
...
from models.models import (
    Advisor, College, Course, CourseRecommendation, Curriculum,
    DecisionStatus, Department, DepartmentEntryRequirement, MajorSurvey,
    RequirementCourse, Student, StudentCourse, SurveyRound,
)
from models.schemas import (
    AdvisorDataUpload, CollegeDataUpload, CourseDataUpload, CurriculumDataUpload,
    DataUploadResponse, DepartmentDataUpload, EnrollmentDataUpload, ErrorDetail,
